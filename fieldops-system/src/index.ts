...
// Rastreador para garantir que o código novo foi carregado
console.log('🔥 [DEBUG] Lendo o arquivo index.ts ATUALIZADO!');
...
// =======================================================
// ROTA INJETADA AQUI (Com prioridade máxima no Fastify)
// =======================================================
app.get('/users', async (request, reply) => {
  console.log('✅ [DEBUG] O frontend acessou a rota /users com SUCESSO!');
  try {
    ...
    return reply.status(500).send({ error: 'Erro ao buscar usuários no banco' });
  }
});
